...
system_prompt="""
 ...
 3. If the user requests a list of tasks, present the output in a structured tasks format to ensure a clean and organized display in the browser.
...
st.subheader("📋TaskBot - Manage your tasks with AI")
...
prompt = st.chat_input("Ask me to manage your Tasks efficiently...")
